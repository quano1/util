...
//     }
//     {
//         ring_buffer_dd<char, PROFILING> fifo{kCapacity, 0x2000};
//         SequenceFixedSize<kExtend>(fifo, kPkgSize, resting, threads_lst, time_lst, total_size_lst, total_count_lst);
//     }
//     threads_lst.clear();
//     {
//         ring_buffer_dd<char, PROFILING> fifo{kCapacity, 0x4000};
//         SequenceFixedSize<kExtend>(fifo, kPkgSize, resting, threads_lst, time_lst, total_size_lst, total_count_lst);
//     }
...
TEST_F(StressTestRingBuffer, RushSequence)
{
    ...
    {
        ring_buffer_dd<char, PROFILING> fifo{kCapacity, 0x200};
        SequenceFixedSize<kExtend>(fifo, 3, resting);
    }
    {
        ring_buffer_dd<char, PROFILING> fifo{kCapacity, 0x400};
    ...
    {
        ring_buffer_dd<char, PROFILING> fifo{kCapacity, 0x800};
        SequenceFixedSize<kExtend>(fifo, 3, resting);
    }
...
TEST_F(StressTestRingBuffer, DDRushConcurrent)
{
    ...
    // {
    //     ring_buffer_dd<char, PROFILING> fifo{kCapacity};
...
TEST_F(StressTestRingBuffer, DDRushSequence)
{
    ...
    // {
    //     ring_buffer_dd<char, PROFILING> fifo{kCapacity, 0x40};
    //     SequenceFixedSize<kExtend>(fifo, kPkgSize, resting);
    //     stat_lst.push_back(fifo.statistics());
    // }

    // {
    //     ring_buffer_dd<char, PROFILING> fifo{kCapacity, 0x80};
    //     SequenceFixedSize<kExtend>(fifo, kPkgSize, resting);
    //     stat_lst.push_back(fifo.statistics());
    // }
