...
void llt_log_init(struct LogMngr **aLogger, size_t aWorkerNum);
...
#define LOG_INIT(logger, workerNum, async) llt_log_init(&logger, workerNum); llt_set_async(logger, async)
